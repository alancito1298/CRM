      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Tokens consumidos en tu clave de proveedor por borradores y el bot
              de auto-respuestas. Solo métricas numéricas, no se almacena contenido de mensajes.
            </CardDescription>
          </div>
          <Select
            value={String(days)}
      ...
      <CardContent className="space-y-5">
        {loading || !data ? (
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-10 text-center text-sm text-muted-foreground">
            ...
            <p>Aún no hay consumo de IA en los últimos {data.window_days} días.</p>
            <p className="text-xs">
              Esta sección se irá completando a medida que el asistente responda o redacte borradores.
            </p>
          </div>
        ) : (
          <>
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <Stat label="Llamadas a la IA" value={String(data.totals.calls)} />
              <Stat
            ...
            {data.truncated && (
              <p className="text-xs text-muted-foreground">
                Mostrando una ventana parcial: el volumen es elevado y solo se resumen los registros más recientes.
              </p>
            )}
          </>
        )}
