...
-- START 002_pipelines_enhancements.sql
-- ============================================================
...
-- END 002_pipelines_enhancements.sql

-- START 003_broadcast_recipient_wamid.sql
-- ============================================================
...
-- END 003_broadcast_recipient_wamid.sql

-- START 004_contact_delete_set_null.sql
-- ============================================================
...
-- END 004_contact_delete_set_null.sql

-- START 005_broadcast_counts_incremental.sql
-- ============================================================
...
-- END 005_broadcast_counts_incremental.sql

-- START 006_automations.sql
-- ============================================================
...
-- END 006_automations.sql

-- START 007_automations_increment_counter.sql
-- ============================================================
...
-- END 007_automations_increment_counter.sql

-- START 008_profile_avatars_storage.sql
-- ============================================================
...
-- END 008_profile_avatars_storage.sql

-- START 009_message_actions.sql
-- ============================================================
...
-- START 011_profile_beta_features.sql
-- ============================================================
...
-- END 011_profile_beta_features.sql

-- START 012_flows_increment_counter.sql
-- ============================================================
...
-- END 012_flows_increment_counter.sql

-- START 013_whatsapp_config_phone_number_id_unique.sql
-- ============================================================
...
-- END 013_whatsapp_config_phone_number_id_unique.sql

-- START 014_message_templates_meta_integration.sql
-- ============================================================
...
-- END 014_message_templates_meta_integration.sql

-- START 015_whatsapp_config_registration.sql
-- ============================================================
...
-- END 015_whatsapp_config_registration.sql

-- START 016_flow_media.sql
-- ============================================================
-- 016_flow_media.sql
--
...
-- END 016_flow_media.sql

-- START 017_account_sharing.sql
-- ============================================================
...
-- END 017_account_sharing.sql

-- START 018_account_member_rpcs.sql
-- ============================================================
...
-- END 018_account_member_rpcs.sql

-- START 019_invitation_rpcs.sql
-- ============================================================
...
-- END 019_invitation_rpcs.sql

-- START 020_account_sharing_followups.sql
-- ============================================================
...
-- END 020_account_sharing_followups.sql

-- START 021_account_default_currency.sql
-- ============================================================
...
-- END 021_account_default_currency.sql

-- START 022_contact_phone_dedup.sql
-- ============================================================
...
-- END 022_contact_phone_dedup.sql

-- START 023_chat_media.sql
-- ============================================================
-- 023_chat_media.sql
--
...
-- END 023_chat_media.sql

-- START 024_member_presence.sql
-- ============================================================
...
-- END 024_member_presence.sql

-- START 025_filter_contacts_by_tags.sql
-- ============================================================
...
-- END 025_filter_contacts_by_tags.sql

-- START 026_api_keys.sql
-- ============================================================
...
-- END 026_api_keys.sql

-- START 027_notifications.sql
-- ============================================================
-- NOTIFICATIONS
-- ============================================================
...
-- END 027_notifications.sql

-- START 028_webhook_endpoints.sql
-- ============================================================
...
-- END 028_webhook_endpoints.sql

-- START 029_ai_reply.sql
-- ============================================================
...
-- END 029_ai_reply.sql

-- START 030_ai_knowledge.sql
-- ============================================================
...
-- END 030_ai_knowledge.sql

-- START 031_ai_reply_slot_grant.sql
-- ============================================================
...
-- END 031_ai_reply_slot_grant.sql

-- START 032_fix_ai_knowledge_membership.sql
-- ============================================================
...
-- END 032_fix_ai_knowledge_membership.sql

-- START 033_ai_reply_polish.sql
-- ============================================================
...
-- END 033_ai_reply_polish.sql

-- START 034_fix_profiles_update_rls.sql
-- ============================================================
...
-- END 034_fix_profiles_update_rls.sql

-- START 035_interactive_messages.sql
-- ============================================================
...
-- END 035_interactive_messages.sql

-- START 036_conversation_contact_dedup.sql
-- ============================================================
...
-- END 036_conversation_contact_dedup.sql

-- START 037_ai_providers_and_notifications.sql
-- ============================================================
...
-- END 037_ai_providers_and_notifications.sql
